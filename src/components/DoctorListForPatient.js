                                ...
                                this.state.doctors.map(
                                    doctor =>
                                        <tr key={doctor.id}>
                                            ...
                                            <td>{doctor.area}</td>
                                            <td>
                                                <NavLink className="btn btn-success btn-link text-decoration-none text-light" to={{pathname:'/doctor-appointment-slots',state:{doctor:doctor, doctorId:doctor.id}}}>Book Appointment</NavLink>
                                            </td>
                                        </tr>
                                )
                            }
