...
class DoctorAppointmentHistory extends Component {
    ...
    <NavLink
        ...
        to={{ pathname: '/patient-details-for-doctor', state: { appointmentId: appointment.id } }}
    >
        Patient Details
    </NavLink>
    <NavLink
        className="btn btn-primary btn-link text-light text-decoration-none offset-1 ml-2"
        to={{ pathname: '/prescriptions', state: { appointmentId: appointment.id } }}
    >
        Add Prescription
    </NavLink>
</td>
