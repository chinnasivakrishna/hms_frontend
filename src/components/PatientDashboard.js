                        ...
                        <div className="col-sm-6">
                            <div className="card">
                                ...
                                <h5 className="card-title with-icon">
                                    <i className="fas fa-dailygoals" /> DailyGoals
                                </h5>
                                <p className="card-text">Access and manage your DailyGoals</p>
                                <button onClick={() => this.props.history.push('/daily-goals')} className="btn btn-info">View</button>
                                </div>
                            </div>
                            </div>
